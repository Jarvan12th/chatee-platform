...
const ConversationList: React.FC<ConversationListProps> = ({
  ...
  useEffect(() => {
    ...
    const conversationDeleteHandler = (conversation: FullConversationType) => {
      setItems((current) => {
    ...
    pusherClient.bind("conversation:delete", conversationDeleteHandler);

    return () => {
      pusherClient.unsubscribe(pusherKey);
      pusherClient.unbind("conversation:new", newConversationHandler);
      pusherClient.unbind("conversation:update", conversationUpdateHandler);
      pusherClient.unbind("conversation:delete", conversationDeleteHandler);
    };
